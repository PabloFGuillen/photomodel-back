...
public interface CreateUserUseCase {
    ...
    User createUser(String username, String email, String password, UserType level, UserRole rol) throws ExistingUserException, CreateUserObligatoryInformationNotSettedExeption;
}
