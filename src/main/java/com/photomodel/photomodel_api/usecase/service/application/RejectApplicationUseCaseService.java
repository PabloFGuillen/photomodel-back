...
public class RejectApplicationUseCaseService implements RejectApplicationUseCase {
    ...
    @Override
    public void rejectApplicationUseCase(String applicationId) throws ProjectNotFromUserException, CannotModifyApplicationException, ApplicationDoesNotExistException {
